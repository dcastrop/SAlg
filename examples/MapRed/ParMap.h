...
typedef struct pair_vec_vec_int_vec_vec_int {
            vec_vec_int_t fst; vec_vec_int_t snd;
        } pair_vec_vec_int_vec_vec_int_t;

vec_vec_int_t cat(pair_vec_vec_int_vec_vec_int_t);

typedef enum unit {
            Unit
        } unit_t;

vec_vec_int_t prod(vec_vec_int_t);

vec_vec_int_t parProd(vec_vec_int_t);
